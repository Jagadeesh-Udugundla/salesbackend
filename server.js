...
// mongoose.connect("mongodb+srv://jagadeeshu9951:saleassist@cluster0.uspkv5c.mongodb.net/?retryWrites=true&w=majority").then(
//     ()=>console.log("Db connected")
// ).catch(
//     error=>console.log("Db connect eerror")
// )
